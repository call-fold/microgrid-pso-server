...
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns__mgopfserver(struct soap*, struct ns__mgopfserver *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns__mgopfserver(struct soap*, const struct ns__mgopfserver *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns__mgopfserver(struct soap*, const char*, int, const struct ns__mgopfserver *, const char*);
SOAP_FMAC3 struct ns__mgopfserver * SOAP_FMAC4 soap_in_ns__mgopfserver(struct soap*, const char*, struct ns__mgopfserver *, const char*);
SOAP_FMAC1 struct ns__mgopfserver * SOAP_FMAC2 soap_instantiate_ns__mgopfserver(struct soap*, int, const char*, const char*, size_t*);

inline struct ns__mgopfserver * soap_new_ns__mgopfserver(struct soap *soap, int n = -1) { return soap_instantiate_ns__mgopfserver(soap, n, NULL, NULL, NULL); }

inline struct ns__mgopfserver * soap_new_req_ns__mgopfserver(
	struct soap *soap)
{	struct ns__mgopfserver *_p = soap_new_ns__mgopfserver(soap);
	if (_p)
	{	soap_default_ns__mgopfserver(soap, _p);
	}
	return _p;
}

inline struct ns__mgopfserver * soap_new_set_ns__mgopfserver(
	struct soap *soap,
	char *processNum,
	char *host,
	char *user,
...
{	struct ns__mgopfserver *_p = soap_new_ns__mgopfserver(soap);
	if (_p)
	{	soap_default_ns__mgopfserver(soap, _p);
		_p->processNum = processNum;
		_p->host = host;
		_p->user = user;
		_p->password = password;
		_p->dbName = dbName;
		_p->port = port;
		_p->algorithmID = algorithmID;
	}
	return _p;
}
SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns__mgopfserver(struct soap*, const struct ns__mgopfserver *, const char*, const char*);

#ifndef soap_write_ns__mgopfserver
#define soap_write_ns__mgopfserver(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || (soap_serialize_ns__mgopfserver(soap, data), 0) || soap_put_ns__mgopfserver(soap, data, "ns:mgopfserver", NULL) || soap_end_send(soap), (soap)->error )
#endif

SOAP_FMAC3 struct ns__mgopfserver * SOAP_FMAC4 soap_get_ns__mgopfserver(struct soap*, struct ns__mgopfserver *, const char*, const char*);

#ifndef soap_read_ns__mgopfserver
#define soap_read_ns__mgopfserver(soap, data) ( ((data) ? (soap_default_ns__mgopfserver(soap, (data)), 0) : 0) || soap_begin_recv(soap) || !soap_get_ns__mgopfserver(soap, (data), NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif
...
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns__mgopfserverResponse(struct soap*, struct ns__mgopfserverResponse *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns__mgopfserverResponse(struct soap*, const struct ns__mgopfserverResponse *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns__mgopfserverResponse(struct soap*, const char*, int, const struct ns__mgopfserverResponse *, const char*);
SOAP_FMAC3 struct ns__mgopfserverResponse * SOAP_FMAC4 soap_in_ns__mgopfserverResponse(struct soap*, const char*, struct ns__mgopfserverResponse *, const char*);
SOAP_FMAC1 struct ns__mgopfserverResponse * SOAP_FMAC2 soap_instantiate_ns__mgopfserverResponse(struct soap*, int, const char*, const char*, size_t*);

inline struct ns__mgopfserverResponse * soap_new_ns__mgopfserverResponse(struct soap *soap, int n = -1) { return soap_instantiate_ns__mgopfserverResponse(soap, n, NULL, NULL, NULL); }

inline struct ns__mgopfserverResponse * soap_new_req_ns__mgopfserverResponse(
	struct soap *soap)
{	struct ns__mgopfserverResponse *_p = soap_new_ns__mgopfserverResponse(soap);
	if (_p)
	{	soap_default_ns__mgopfserverResponse(soap, _p);
	}
	return _p;
}

inline struct ns__mgopfserverResponse * soap_new_set_ns__mgopfserverResponse(
	struct soap *soap,
	int *status)
{	struct ns__mgopfserverResponse *_p = soap_new_ns__mgopfserverResponse(soap);
	if (_p)
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns__mgopfserverResponse(struct soap*, const struct ns__mgopfserverResponse *, const char*, const char*);

#ifndef soap_write_ns__mgopfserverResponse
#define soap_write_ns__mgopfserverResponse(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || (soap_serialize_ns__mgopfserverResponse(soap, data), 0) || soap_put_ns__mgopfserverResponse(soap, data, "ns:mgopfserverResponse", NULL) || soap_end_send(soap), (soap)->error )
#endif

SOAP_FMAC3 struct ns__mgopfserverResponse * SOAP_FMAC4 soap_get_ns__mgopfserverResponse(struct soap*, struct ns__mgopfserverResponse *, const char*, const char*);

#ifndef soap_read_ns__mgopfserverResponse
#define soap_read_ns__mgopfserverResponse(soap, data) ( ((data) ? (soap_default_ns__mgopfserverResponse(soap, (data)), 0) : 0) || soap_begin_recv(soap) || !soap_get_ns__mgopfserverResponse(soap, (data), NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif
